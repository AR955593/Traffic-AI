...
def get_kanpur_network() -> Tuple[Dict[str, Tuple[float, float]], Dict[str, RoadSegment]]:
    ...
    segments_def = [
        ...
        ("SEG005", "Azad Nagar Ring Link", "Arterial", 4, 50.0, "N03", "N06", [nodes["N03"], (26.4740, 80.3420), (26.4680, 80.3395), (26.4645, 80.3425), nodes["N06"]]),
        ...
        ("SEG011", "Harsh Nagar Express Link", "Arterial", 4, 50.0, "N06", "N10", [nodes["N06"], (26.4570, 80.3415), (26.4510, 80.3385), (26.4465, 80.3420), nodes["N10"]]),
        ...
        ("SEG017", "Kanpur Central Station Arterial", "Arterial", 4, 45.0, "N10", "N13", [nodes["N10"], (26.4380, 80.3410), (26.4320, 80.3385), (26.4285, 80.3425), nodes["N13"]]),
